                        ...
                        child: Row(
                          children: [
                            ...
                            if(pumpHideShow['range'])
                              getCell(width: 120, title: 'Range (l/hr)'),
                            ...
                            if(pumpHideShow['lowerTankLevel'])
                              getCell(width: 120, title: 'Lower Tank Level'),
                            if(pumpHideShow['upperTankLevel'])
                              getCell(width: 120, title: 'Upper Tank Level'),
                                                ...
                                                children: [
                                                  ...
                                                  if(pumpHideShow['lowerTankLevel'])
                                                    Container(
                                                      ...
                                                      alignment: Alignment.centerLeft,
                                                      child: Center(
                                                          child: getFloat(initialValue: constantPvd.pumpUpdated[i]['lowerTankLevel'], list: ['-',...constantPvd.levelSensorUpdated.map((ls)=>'${ls['name'].toString()} -- ${ls['hid'].toString()}').toList()], constantPvd: constantPvd, route: 'lowerTankLevel', pump: i)
                                                      ),
                                                    ),
                                                  if(pumpHideShow['upperTankLevel'])
                                                    Container(
                                                      ...
                                                      alignment: Alignment.centerLeft,
                                                      child: Center(
                                                          child: getFloat(initialValue: constantPvd.pumpUpdated[i]['upperTankLevel'], list: ['-',...constantPvd.levelSensorUpdated.map((ls)=>'${ls['name'].toString()} -- ${ls['hid'].toString()}').toList()], constantPvd: constantPvd, route: 'upperTankLevel', pump: i)
                                                      ),
                                                    ),
                                                ],
                                              ),
