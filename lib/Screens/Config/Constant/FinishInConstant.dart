  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Center(
        child: InkWell(
          onTap: ()async{
            var validation = (constantPvd.generalUpdated[6]['value'] == constantPvd.generalUpdated[7]['value']) ? false : true;
            if(validation){
              var flag = 0;
                          ...
                          onTap: ()async{
                            ...
                            try{
                              ...
                              var response = await service.postRequest('createUserConstant', {
                                ...
                                'hardware' : constantPvd.sendDataToHW()
                              });
              ...
              showDialog(context: context, builder: (context){
                return AlertDialog(
                  ...
                  content: Text('Lora keys should not be same'),
                  actions: [
                    TextButton(
                        onPressed: (){
                          Navigator.pop(context);
