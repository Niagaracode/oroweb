                          ...
                          children: [
                            ...
                            if(fertilizerHideShow['selector'])
                             ...
                             if(fertilizerHideShow['nominalFlow'])
                              getCell(width: 120, title: 'Nominal Flow (l/hr)'),
                                              ...
                                              children: [
                                               ...
                                               if(fertilizerHideShow['agitator'])
                                                Container(
                                                  ...
                                                  width: 120,
                                                  height: (50.2 * (constantPvd.fertilizerUpdated[i]['fertilizer'].length)).toDouble(),
                                                  child: getYourWidgetFertilizer(context: context, fertilizer: null, type: 2, initialValue: constantPvd.fertilizerUpdated[i]['agitator'], route: 'agitator', site: i,list: constantPvd.agitatorList),
                                                ),
                                                if(fertilizerHideShow['selector'])
                                                  Container(
                                                    color: Colors.white,
                                                    ...
                                                    width: 120,
                                                    height: (50.2 * (constantPvd.fertilizerUpdated[i]['fertilizer'].length)).toDouble(),
                                                    child: getYourWidgetFertilizer(context: context, fertilizer: null, type: 2, initialValue: constantPvd.fertilizerUpdated[i]['selector'], route: 'selector', site: i,list: constantPvd.selectorList),
                                                  ),
                                                Column(
                                                  children: [
