                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                if(lineHideShow['pump'])
                                                  ...
                                                  width: 120,
                                                  height: 50,
                                                  child: getYourWidgetIrrigationLine(context: context, index: i, type: 2, initialValue: constantPvd.irrigationLineUpdated[i]['pump'], route: 'pump',list: constantPvd.pumpList),
                                                ),
                                                if(lineHideShow['lowFlowDelay'])
                                                  Container(
                                                  margin: const EdgeInsets.only(left: 1,right: 1,bottom: 1),
