...
import 'package:oro_irrigation_new/Screens/Config/Constant/global_alarm.dart';
...
class _ConstantInConfigState extends State<ConstantInConfig> with TickerProviderStateMixin{
  ...
  Future<void> getUserConstant() async {
    ...
    try{
      ...
      jsonData['data']['default']["levelSensor"].addAll(jsonData['data']['default']["lowerTankLevelSensor"]);
      jsonData['data']['default']["levelSensor"].addAll(jsonData['data']['default']["upperTankLevelSensor"]);
      print('see :::: ${jsonData['data']['default']["levelSensor"]}');
