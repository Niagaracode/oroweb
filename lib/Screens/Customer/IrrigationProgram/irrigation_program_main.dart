...
import 'package:oro_irrigation_new/Screens/Customer/ProgramSchedule.dart';
...
class IrrigationProgram extends StatefulWidget {
  ...
  const IrrigationProgram({Key? irrigationProgramKey,
    ...
    required this.conditionsLibraryIsNotEmpty,
    required this.deviceId, required this.toDashboard}) :super(key: irrigationProgramKey);
...
class _IrrigationProgramState extends State<IrrigationProgram> with SingleTickerProviderStateMixin {
  ...
  final IrrigationProgramProvider irrigationProvider = IrrigationProgramProvider();
  ...
  void getData(IrrigationProgramProvider programPvd, userId, controllerId, serialNumber)async{
  ...
  Widget build(BuildContext context) {
    ...
    final mainProvider = Provider.of<IrrigationProgramProvider>(context);
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        const Text("Pump station range is not sufficient for total zone's valve flow rate!", style: const TextStyle(fontWeight: FontWeight.w300, fontStyle: FontStyle.italic),),
                        const SizedBox(height: 10,),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
  ...
  void validatorFunction(BuildContext context, IrrigationProgramProvider mainProvider) {
  ...
  void _showAdaptiveDialog(BuildContext context, IrrigationProgramProvider programProvider,) {
    showAdaptiveDialog(
      context: context,
  ...
  Widget _buildTabContent({required int index, required bool isIrrigationProgram, required bool conditionsLibraryIsNotEmpty}) {
    // print("isIrrigationProgram ==> $isIrrigationProgram");
    switch (index) {
      case 0:
