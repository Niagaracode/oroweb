...
class ListOfFertilizerInSet extends StatefulWidget {
  ...
  ListOfFertilizerInSet({super.key, required this.index, required this.recipeIndex,this.doingAdd,required this.length,required this.screenWidth,required this.screenHeight});
