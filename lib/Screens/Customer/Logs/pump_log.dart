...
class NewPumpLogScreen extends StatefulWidget {
  ...
  const NewPumpLogScreen({super.key, required this.userId, required this.controllerId, this.nodeControllerId = 0, this.showAppBar = false});
...
class _NewPumpLogScreenState extends State<NewPumpLogScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: widget.showAppBar ? AppBar(title: Text("Pump Log"),) : PreferredSize(preferredSize: Size.zero, child: Container()),
