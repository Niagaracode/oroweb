...
import '../../../widgets/SCustomWidgets/wave_view.dart';
...
class _PumpControllerDashboardState extends State<PumpControllerDashboard> with TickerProviderStateMixin{
  ...
  Future<void> getPumpControllerData() async {
    ...
    try {
      ...
      mqttPayloadProvider.pumpControllerPayload = {};
      ...
      deviceName = response['data'][widget.selectedSite]['master'][widget.selectedMaster]['deviceName'];
    } catch(e) {
      print(e);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return (mqttPayloadProvider.dataModel != null && mqttPayloadProvider.dataModel!.pumps.isNotEmpty) ? Center(
      child: ListView(
        children: [
          const SizedBox(height: 10,),
          ConnectionErrorToast(isConnected: mqttPayloadProvider.pumpControllerPayload.isNotEmpty),
          // SizedBox(height: 10,),
          Container(
            ...
            child: ListTile(
              ...
              //   text: TextSpan(
              //     children: [
              //       TextSpan(text: deviceName, style: TextStyle(fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor)),
              //       TextSpan(text: widget.deviceId, style: TextStyle(fontWeight: FontWeight.w400, color: Theme.of(context).primaryColor)),
              //     ],
              //   ),
              // ),
              title: Text(deviceName, style: TextStyle(fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor),),
                    ...
                    children: [
                      BounceEffectButton(
                          ...
                          onTap: () async {
                            ...
                            // print(individualPump.cyclicOffDelay);
                          }
                      ),
                      BounceEffectButton(
                          label: "OFF",
