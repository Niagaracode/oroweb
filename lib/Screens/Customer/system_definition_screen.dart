...
class SystemDefinition extends StatefulWidget {
  ...
  const SystemDefinition({super.key, required this.userId, required this.controllerId, required this.deviceId});
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: constraints.maxWidth * 0.02,),
                                        const Text("Enable energy save function"),
                                      ],
                                    ),
                                    const SizedBox(height: 20,),
