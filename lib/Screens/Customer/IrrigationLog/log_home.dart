...
import 'package:oro_irrigation_new/Screens/Customer/IrrigationLog/scrollingTable.dart';
...
class _LogHomeState extends State<LogHome> {
  ...
  dynamic irrigationLogParameterFromServer = {
    ...
    'centralEcPh' : {
      ...
      'CentralPhAverage' : ['Central Ph Average',true,3],
      'CentralPhMaximum' : ['Central Ph Maximum',true,3],
      'CentralPhMinimum' : ['Central Ph Minimum',true,3],
      'CentralEcSetValue' : ['Central Ec Avg',true,3],
      'CentralEcAverage' : ['Central Ec Average',true,3],
      'CentralEcMaximum' : ['Central Ec Maximum',true,3],
      'CentralEcMinimum' : ['Central Ec Minimum',true,3],
      'overAll' : ['over all',true,1]
    },
    '<C - CH1>' : {
