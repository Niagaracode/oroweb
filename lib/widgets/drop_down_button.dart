          ...
          if (newValue != null) {
            ...
            if(widget.pvdName == 'editWaterSource_sp'){
              ...
              if(forWhat[0] == 'm_o_line'){
                ...
                configPvd.mappingOfInputsFunctionality([forWhat[0], int.parse(forWhat[1]), forWhat[2], int.parse(forWhat[3]), forWhat[4],newValue]);
              }else if(forWhat[0] == 'm_i_totalLowerTankLevelSensor'){
                configPvd.mappingOfInputsFunctionality([forWhat[0], int.parse(forWhat[1]), forWhat[2], int.parse(forWhat[3]), forWhat[4],newValue]);
              }else if(forWhat[0] == 'm_i_totalUpperTankLevelSensor'){
                configPvd.mappingOfInputsFunctionality([forWhat[0], int.parse(forWhat[1]), forWhat[2], int.parse(forWhat[3]), forWhat[4],newValue]);
              }else if(forWhat[0] == 'm_i_temperature'){
                configPvd.mappingOfInputsFunctionality([forWhat[0], int.parse(forWhat[1]), forWhat[2], int.parse(forWhat[3]), forWhat[4],newValue]);
              }else if(forWhat[0] == 'm_i_soilTemperature'){
...
void editParameter({
  ...
  if (newValue != null) {
    print('value is : ${newValue}');
    if(pvdName == 'editWaterSource_sp'){
      configPvd.sourcePumpFunctionality(['editWaterSource_sp',index,newValue!]);
    }else if(pvdName == 'editRefNo_sp'){
      configPvd.sourcePumpFunctionality(['editRefNo_sp',index,newValue!]);
    }else if(pvdName == 'editRefNo_ip'){
      configPvd.irrigationPumpFunctionality(['editRefNo_ip',index,newValue!]);
    }else if(pvdName == 'editCentralDosing'){
      configPvd.irrigationLinesFunctionality(['editCentralDosing',index,newValue!]);
    }else if(pvdName == 'editCentralFiltration'){
      configPvd.irrigationLinesFunctionality(['editCentralFiltration',index,newValue!]);
    }else if(pvdName == 'editIrrigationPump'){
      configPvd.irrigationLinesFunctionality(['editIrrigationPump',index,newValue!]);
    }else{
      print('newValue : $newValue');
      var forWhat = pvdName!.split('/');
      if(forWhat[0] == 'm_o_line'){
        configPvd.mappingOfOutputsFunctionality([forWhat[0], int.parse(forWhat[1]), forWhat[2], int.parse(forWhat[3]), forWhat[4],newValue]);
      }else if(forWhat[0] == 'm_i_line'){
        configPvd.mappingOfInputsFunctionality([forWhat[0], int.parse(forWhat[1]), forWhat[2], int.parse(forWhat[3]), forWhat[4],newValue]);
